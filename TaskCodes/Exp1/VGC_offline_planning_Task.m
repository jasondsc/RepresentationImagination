...
% Participants will solve a series of mazes and report on their subsequent  awareness of obstacles                
...
while 1
 ...
 if practice == 1
    ...
    messageWindow = Screen(mainWin,'OpenOffscreenWindow',grey);
    Screen(messageWindow,'TextSize'  , 22)
    Width=Screen(messageWindow,'TextBounds','At the start of each trial, you will have a few seconds to view the obstacles.');
    Screen('DrawText',messageWindow,'At the start of each trial, you will have a few seconds to view the obstacles.',centerX-(round(Width(3)/2)), centerY-300, white);
    Width=Screen(messageWindow,'TextBounds','Afterwards the obstacles will disappear, and the start and goal location will appear.');
    Screen('DrawText',messageWindow,'Afterwards the obstacles will disappear, and the start and goal location will appear.',centerX-(round(Width(3)/2)), centerY-240, white);
    Width=Screen(messageWindow,'TextBounds','You will have a few seconds to plan on how to solve the maze.');
    Screen('DrawText',messageWindow,'You will have a few seconds to plan on how to solve the maze.',centerX-(round(Width(3)/2)), centerY-180, white);
    Width=Screen(messageWindow,'TextBounds','When the red circle (your avatar) appears you can begin to navigate the maze.');
    Screen('DrawText',messageWindow,'When the red circle (your avatar) appears you can begin to navigate the maze.',centerX-(round(Width(3)/2)), centerY-120, white);
    ...
    messageWindow = Screen(mainWin,'OpenOffscreenWindow',grey);
    Screen(messageWindow,'TextSize'  , 22)
    Width=Screen(messageWindow,'TextBounds','On some trials, you will need to navigate to solve the maze.');
    Screen('DrawText',messageWindow,'On some trials, you will need to navigate to solve the maze.',centerX-(round(Width(3)/2)), centerY-300, white);
    Width=Screen(messageWindow,'TextBounds','On other trials, you will view the obstacles and plan but not navigate the maze.');
    Screen('DrawText',messageWindow,'On other trials, you will view the obstacles and plan but not navigate the maze.',centerX-(round(Width(3)/2)), centerY-240, white);
    Width=Screen(messageWindow,'TextBounds','These trials will interleave randomly, so you should PLAN TO SOLVE THE MAZE on every trial.');
    Screen('DrawText',messageWindow,'These trials will interleave randomly, so you should PLAN TO SOLVE THE MAZE on every trial.',centerX-(round(Width(3)/2)), centerY-180, white);
    Width=Screen(messageWindow,'TextBounds','This is important as we will also ask you about your plan on EVERY TRIAL.');
    Screen('DrawText',messageWindow,'This is important as we will also ask you about your plan on EVERY TRIAL.',centerX-(round(Width(3)/2)), centerY-120, white);    
    ...
    messageWindow = Screen(mainWin,'OpenOffscreenWindow',grey);
    Screen(messageWindow,'TextSize'  , 22)
    Width=Screen(messageWindow,'TextBounds','We are interested in your thought process while planning each maze');
    Screen('DrawText',messageWindow,'We are interested in your thought process while planning each maze',centerX-(round(Width(3)/2)), centerY-300, white);
    ...
    Width=Screen(messageWindow,'TextBounds','Your answer should reflect the amount of ATTENTION you paid on this obstacle');
    Screen('DrawText',messageWindow,'Your answer should reflect the amount of ATTENTION you paid on this obstacle',centerX-(round(Width(3)/2)), centerY-180, white);
...
%------------------------------------------------------------------------------------------
                ...
                index_obs=find(sum(colour_stims2) ==2 & colour_stims2(3,:) ==1  & colour_stims2(2,:) ==1  & colour_stims2(1,:) ==0);
                colour_stims([1],index_obs)=1;
                    ...
                    Screen('DrawLines',mainWin,center_fix_loc, 7, white);
                    Screen('DrawDots', mainWin, [centerX, centerY-15], 7, black, [], 2)
                    PostPlanningWinTime= Screen('flip',mainWin,PlanningDelayWinTime + (360*IFI) - slack,0);
                 ...
                 if trialMatrix.Sperling(this_practicetrial) ==1
                    ...
                    Screen('DrawLines',mainWin,center_fix_loc, 7, white);
                    Screen('DrawDots', mainWin, [centerX, centerY-15], 7, black, [], 2)
                    ResponseWinTime= Screen('flip',mainWin,PlanningDelayWinTime + (60*IFI) - slack,0);
